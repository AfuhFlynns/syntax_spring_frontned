  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 bg-transparent md:px-0">
      ...
      >
        ...
        <pre className="mb-2 text-primary-text">
      ...
      <Link to="/">
        <motion.button
          className="flex flex-row items-center gap-2 px-6 py-3 mt-10 text-lg text-white bg-blue-500 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 hover:scale-[1.02]"
          initial="initial"
          animate="animate"
          exit="exit"
          variants={animationVariants}
