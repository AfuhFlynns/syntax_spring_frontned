...
const FeaturesSection = () => {
  return (
    <div className="flex flex-row items-start justify-center w-full md:h-full h-[80%] md:mt-0 -mt-[2rem]">
      <section className="md:w-full md:h-[60%] h-full w-[96%] self-center py-10 bg-secondary-bg section-border rounded-lg flex flex-row items-center">
        <div className="flex flex-col items-center justify-start w-full h-full gap-4 px-6 mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="text-center text-primary-text">
              ...
              <p className="text-gray-300">
                Engage with step-by-step tutorials and hands-on exercises
